...
$customer_mobile_lbl = '';
$customer_mobile     = '';
if($extra_field->displayValueMobile( 7, 8, $this->userdata->users_info_id )) {
	$customer_mobile_lbl = 'Mobile Number';
	$customer_mobile = ': '. $extra_field->displayValueMobile( 7, 8, $this->userdata->users_info_id );
}
$template_desc = str_replace('{mobile_lbl}', $customer_mobile_lbl , $template_desc);
$template_desc = str_replace('{mobile}', $customer_mobile ,$template_desc);
//End

//Birthday
$customer_birthday_lbl = '';
$customer_birthday     = '';
if($extra_field->displayValueMobile( 7, 6, $this->userdata->users_info_id )) {
	$customer_birthday_lbl = 'Birthday';
	$customer_birthday = ': '. $extra_field->displayValueMobile( 7, 6, $this->userdata->users_info_id );
}
$template_desc = str_replace('{birthday_lbl}', $customer_birthday_lbl , $template_desc);
$template_desc = str_replace('{birthday}', $customer_birthday ,$template_desc);
//End

//Age
$customer_age_lbl = '';
$customer_age     = '';
if($extra_field->displayValueMobile( 7, 7, $this->userdata->users_info_id )) {
	$customer_age_lbl = 'Age';
	$customer_age = ': '. $extra_field->displayValueMobile( 7, 7, $this->userdata->users_info_id );
}
$template_desc = str_replace('{age_lbl}', $customer_age_lbl , $template_desc);
$template_desc = str_replace('{age}', $customer_age ,$template_desc);
//End

//Gender
$customer_gender_lbl = '';
$customer_gender     = '';
if($extra_field->displayValueMobile( 7, 9, $this->userdata->users_info_id )) {
	$customer_gender_lbl = 'Gender';
	$customer_gender = ': '. $extra_field->displayValueMobile( 7, 9, $this->userdata->users_info_id );
}
$template_desc = str_replace('{gender_lbl}', $customer_gender_lbl , $template_desc);
$template_desc = str_replace('{gender}', $customer_gender ,$template_desc);
//End
